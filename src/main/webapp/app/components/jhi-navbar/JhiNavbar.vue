<template>
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-link class="jh-navbar-toggler d-lg-none float-right" href="javascript:void(0);" data-toggle="collapse"
...
<script lang="ts" src="./JhiNavbar.component.ts">
</script>
...
<style scoped>
    ...
    .logo-img {
        height: 100%;
        background: url("../../../content/images/confluent-logo-300.png") no-repeat center center;
